...
LDFLAGS="-s -w -X github.com/china-li-shuo/itshujia/utils.GitHash=${GITHASH} -X github.com/china-li-shuo/itshujia/utils.BuildAt=${BUILDAT} -X github.com/china-li-shuo/itshujia/utils.Version=${VERSION}"
